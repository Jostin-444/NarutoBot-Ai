...
console.error(chalk.bold.cyanBright(`🥀 Error al iniciar Naruto-Creative: `, error))
}
})();
...
let prekey = []
let directorio = readdirSync("./NarutoSession")
...
const directories = ['./YukiSession/', './NarutoJadiBot/']
